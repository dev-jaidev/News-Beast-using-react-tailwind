...
function NewsComponent(props) {
  ...
  return (
    <div className="p-4 md:w-1/3">
          <div className="h-full border-2 border-gray-800 rounded-lg overflow-hidden dark:border-cyan-50">
            ...
            <div className="p-6">
              ...
              <h1 className="title-font text-lg font-medium  dark:text-white mb-3 text-black">{props.heading}</h1>
